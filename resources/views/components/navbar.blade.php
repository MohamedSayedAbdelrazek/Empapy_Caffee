...
<nav class="navbar navbar-expand-lg navbar-main" id="mainNavbar">
    <div class="container">
        ...
        <!-- Cart (Always Visible on Mobile - next to hamburger) -->
        <button class="btn btn-icon cart-toggle position-relative d-lg-none" id="cartToggleMobile" aria-label="السلة">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            ...
            <div class="navbar-actions d-flex align-items-center gap-3">
                ...
                <!-- Cart (Desktop Only) -->
                <button class="btn btn-icon cart-toggle position-relative d-none d-lg-flex" id="cartToggle"
                    aria-label="السلة">
                    <svg class="cart-icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                        width="24px" fill="currentColor">
                        <path
