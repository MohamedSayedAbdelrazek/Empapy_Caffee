...
const CACHE_NAME = 'empapy-caffe-v12'; // Incremented Version
...
self.addEventListener('fetch', (event) => {
    ...
    // CRITICAL FIX: Exclude Stripe Assets and Checkout from any casing
    if (url.href.includes('stripe.com') || url.pathname.includes('checkout')) {
         console.log('[SW] Network Only for: ', url.href);
